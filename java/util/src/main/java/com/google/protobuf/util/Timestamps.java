...
public final class Timestamps {
  ...
  public static long toMillis(Timestamp timestamp) {
    checkValid(timestamp);
    return addExact(
        multiplyExact(timestamp.getSeconds(), MILLIS_PER_SECOND),
  ...
  public static long toMicros(Timestamp timestamp) {
    checkValid(timestamp);
    return addExact(
        multiplyExact(timestamp.getSeconds(), MICROS_PER_SECOND),
  ...
  public static long toNanos(Timestamp timestamp) {
    checkValid(timestamp);
    return addExact(multiplyExact(timestamp.getSeconds(), NANOS_PER_SECOND), timestamp.getNanos());
  }
